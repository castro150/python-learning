...
# Para fazer um executável standalone, instalar 'pip install pyinstaller', e para
# executar, basta fazer 'pyinstaller --onefile --windowed {script}', nesse caso frontend.py
